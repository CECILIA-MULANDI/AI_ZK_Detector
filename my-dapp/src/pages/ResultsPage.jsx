        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-gray-800 rounded-xl p-8 mb-8">
            ...
            <div className="text-center mb-8">
              <div className={`text-6xl mb-4 ${result.predicted_class === 1 ? 'text-red-500' : 'text-green-500'}`}>
            ...
            <div className="bg-gray-700 rounded-lg p-6 mb-8">
              ...
              <div className={`text-xl font-bold ${result.proofValid ? 'text-green-400' : 'text-red-400'}`}>
            ...
            <div className="bg-gray-700 rounded-lg p-6 mb-8">
              ...
              <p className="font-mono text-sm break-all">
                {result.image_hash.map(byte => byte.toString(16).padStart(2, '0')).join('')}
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                onClick={downloadPDF}
                className="flex-1 bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-6 rounded-full transition-all duration-300"
              >
                Download Report (PDF)
              </button>
              <button
